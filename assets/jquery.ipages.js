...
;(function($, window, document, undefined) {
	...
	iPages.prototype = {
		...
		defaults: {
			...
			flipDuration: 1000, // Sets the amount of time (ms) necessary to flip a page
			
			pageNumbers: false, // If set to true, the automatic page numbering is enabled
			...
			toolbar: false, // Show/hide the toolbar control
			toolbarControls: [
